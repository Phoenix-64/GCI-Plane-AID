...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.callsing_input.setFocusPolicy(QtCore.Qt.StrongFocus)
        ...
        self.target_input.setFocusPolicy(QtCore.Qt.StrongFocus)
        ...
        self.weapons_input.setFocusPolicy(QtCore.Qt.StrongFocus)
        ...
        self.fuel_input.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.fuel_input.setObjectName("fuel_input")
        self.gridLayout.addWidget(self.fuel_input, 1, 5, 1, 1)

        self.notes_input = QtWidgets.QLineEdit(self.gridLayoutWidget)
        self.notes_input.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.notes_input.setObjectName("notes_input")
        self.gridLayout.addWidget(self.notes_input, 1, 6, 1, 1)

        self.register_trigger = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.register_trigger.setObjectName("register_trigger")
        self.register_trigger.setAutoDefault(True)
        self.gridLayout.addWidget(self.register_trigger, 1, 7, 1, 1)

        self.clear_trigger = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.clear_trigger.setObjectName("clear_trigger")
        self.clear_trigger.setAutoDefault(True)
        self.gridLayout.addWidget(self.clear_trigger, 1, 8, 1, 1)
        ...
        self.recorded_display.setFocusPolicy(QtCore.Qt.NoFocus)
        self.recorded_display.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.recorded_display.setTabKeyNavigation(False)
